        ...
        <div className="space-y-8 animate-in fade-in duration-200">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-900 text-white p-6 rounded-3xl shadow-xl">
              ...
              <p className="text-xs text-slate-400 font-bold mt-1">Registered donor accounts</p>
            </div>
            <div className="bg-rose-50 p-6 rounded-3xl border border-rose-200">
              ...
              <p className="text-3xl font-mono font-black text-rose-600">{fulfillmentRate}%</p>
              <p className="text-xs text-rose-700 font-bold mt-1">{fulfilledRequests} of {requests.length} requisitions fulfilled</p>
            </div>
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200">
              <p className="text-[10px] uppercase font-extrabold text-slate-500 tracking-wider">Verified Hospital Nodes</p>
              <p className="text-3xl font-mono font-black text-slate-900">{verifiedHospitalCount}</p>
              <p className="text-xs text-slate-600 font-bold mt-1">Verified hospital accounts</p>
            </div>
            <div className="bg-emerald-50 p-6 rounded-3xl border border-emerald-200">
              ...
              <p className="text-3xl font-mono font-black text-emerald-600">{totalLivesSaved.toLocaleString()}</p>
